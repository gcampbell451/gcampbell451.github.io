...
#region Passing optional parameters, naming parameter values when calling methods, mixing optional and required parameters
...
#region Combining multiple returned values using tuples, naming the fields of a tuple
/*
...
#region Aliasing and deconstructing tuples, deconstructing other types using tuples
/*
...
// you can then access the named fileds
...
WriteLine($"Deconstructed person: {name1}, {dob1}, {fav2}");
*/
#endregion
...
// an array containing a mix of passenter types
...
#region Working with, defining, equality of record types, positional data members in records

 // working with init-only properties

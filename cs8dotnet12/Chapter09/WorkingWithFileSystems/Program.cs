...
// reneder the table to the console
...
SectionTitle("Manging directories");
...
// we must explicitly say which Exists method to use bc we statically imported both Path and Directory
WriteLine($"Does it exist? {Path.Exists(newFolder)}");

WriteLine("Creating it...");
CreateDirectory(newFolder);

// use the Directory.Exists method this time
